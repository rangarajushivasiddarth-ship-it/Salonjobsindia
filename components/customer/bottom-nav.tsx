...
export function BottomNav({ unreadMessages = 0, unreadNotifications = 0 }: BottomNavProps) {
  ...
  const jobSeekerNav: NavItem[] = [
    { id: 'home', label: t('nav.home'), icon: Home, step: user?.isSubscribed ? 'results' : 'discovery' },
    { id: 'about', label: t('nav.about'), icon: Info, step: 'about' },
    { id: 'messages', label: t('nav.messages'), icon: MessageCircle, step: 'messages', badge: unreadMessages },
    { id: 'notifications', label: t('nav.notifications'), icon: Bell, step: 'notifications', badge: unreadNotifications },
    { id: 'profile', label: t('nav.profile'), icon: User, step: 'profile' },
  ]
  
  const salonOwnerNav: NavItem[] = [
    { id: 'home', label: t('owner.manageJobs'), icon: Building2, step: 'owner-panel' },
    { id: 'post', label: t('job.createJob'), icon: Briefcase, step: 'create-job' },
    { id: 'about', label: t('nav.about'), icon: Info, step: 'about' },
    { id: 'messages', label: t('nav.messages'), icon: MessageCircle, step: 'messages', badge: unreadMessages },
    { id: 'profile', label: t('nav.profile'), icon: User, step: 'profile' },
  ]
